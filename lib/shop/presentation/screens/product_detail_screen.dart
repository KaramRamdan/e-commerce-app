...
final String categoryName;
  const ProductDetailScreen({Key? key, required this.id, required this.categoryName}) : super(key: key);
                  ...
                  child: FadeInUp(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(state.productsDetails!.title,
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  state.productsDetails!.category,
                                  style: GoogleFonts.aldrich().copyWith(color: Colors.black,
                                      fontSize: 18),
                                ),
                              ),
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (BuildContext context) =>
                                        ProductDetailScreen(id: category.id, categoryName:category.category ,),
                                  ));
                            },
                            child: Stack(
